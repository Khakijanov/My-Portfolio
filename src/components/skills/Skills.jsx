          ...
          <div className="flex flex-col border border-black rounded-2xl p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                ...
                <p className="text-gray-600 text-[13px]">Advanced</p>
              </div>
            </div>
            <progress
          ...
          <div className="flex flex-col border border-black rounded-2xl p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                ...
                <p className="text-gray-600 text-[13px]">Upper-Intermediate</p>
              </div>
            </div>
            <progress
              className="progress w-full"
          ...
          <div className="flex flex-col border border-black rounded-2xl p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                ...
                <p className="text-gray-600 text-[13px]">Intermediate</p>
              </div>
            </div>
            <progress
              className="progress w-full"
